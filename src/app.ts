...
export class App {
    ...
    rentBike(bikeId: string|undefined|undefined, userEmail: string): void {
    ...
    returnBike(bikeId: string|undefined, userEmail: string|undefined): number {
        const now = new Date()
    ...
    moveBikeTo(bikeId: string|undefined, location: Location) {
